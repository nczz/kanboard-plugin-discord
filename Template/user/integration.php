<div class="panel">
    ...
    <p class="form-help">
        ...
        <?= t('For task description @mentions, also enable the Discord notification type in your Kanboard notification settings. Comment @mentions are pinged on the project comment card when the mentioned user has a Discord User ID mapped.') ?>
    </p>
