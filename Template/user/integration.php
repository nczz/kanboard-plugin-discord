<div class="panel">
    ...
    <p class="form-help">
        ...
        <?= t('The Discord notification type is enabled for users by default when the plugin is installed. It is only needed for task-description @mentions; comment @mentions and overdue task cards use project-level Discord settings instead. Users can opt out from task-description mention cards in Kanboard notification settings.') ?>
    </p>
