...
function version_1(PDO $pdo)
{
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS discord_project_event_rules (
        ...
        discord_enabled TINYINT(1) NULL,
        email_suppressed TINYINT(1) NULL,
        changed_on INT NULL,
        changed_by INT NULL,
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS discord_task_event_rules (
        ...
        event_key VARCHAR(80) NOT NULL,
        mute_discord TINYINT(1) NOT NULL DEFAULT 0,
        mute_email TINYINT(1) NOT NULL DEFAULT 0,
        changed_on INT NULL,
        changed_by INT NULL,
    ...
    $pdo->exec("CREATE TABLE IF NOT EXISTS discord_user_settings (
        ...
        default_notifications_processed TINYINT(1) NOT NULL DEFAULT 0,
        changed_on INT NULL,
        changed_by INT NULL,
        PRIMARY KEY(user_id),
